...
const BROWSERS = [
  {
    href: "https://chrome.google.com/webstore/detail/rate-my-gmu-professors/baadmmacgcbifdhpcghklkcohafjddpc",
    title: "Chrome",
    imageSrc: Chrome,
  },
  {
    href: "https://addons.mozilla.org/firefox/downloads/file/4127343/rate_my_gmu_professors-2.3.0.xpi",
    title: "FireFox",
    imageSrc: FireFox,
  },
  {
